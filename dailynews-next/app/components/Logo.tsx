			...
			<div className="logo">
				<div className="logo-icon">
					<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
						...
						{/* "新"字简化设计 */}
						<path d="M 30 25 L 30 75 M 50 35 L 50 75 M 70 25 L 70 75 M 25 45 L 75 45" stroke="currentColor" strokeWidth="3" strokeLinecap="round" fill="none" />
				...
				{showText && (
					<div className="logo-text">
						<span className="logo-title">新闻联播文字稿 - 每日更新</span>
